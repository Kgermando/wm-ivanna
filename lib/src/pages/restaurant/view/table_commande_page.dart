...
class TableCommandePage extends StatefulWidget {
  const TableCommandePage({super.key});

  @override
  State<TableCommandePage> createState() => _TableCommandePageState();
}

class _TableCommandePageState extends State<TableCommandePage> {
  ...
  Widget tableWidget(TableRestaurantModel data) {
    return restaurantController.obx(
      ...
      return InkWell(
        onTap: () => Get.toNamed(RestaurantRoutes.tableCommandeRestaurantDetail,
            arguments: data),
        child: ClipRRect(
