...
import 'package:wm_com_ivanna/src/pages/restaurant/components/commande/bon_commande.dart';
...
class DetailCommande extends StatefulWidget {
  const DetailCommande({super.key, required this.tableRestaurantModel});
                                              ...
                                              onPressed: () async {
                                                refresh().then((value) =>
                                                    Navigator.pushNamed(
                                                        context,
                                                        RestaurantRoutes
                                                            .tableCommandeRestaurantDetail,
                                                        arguments: value));
                                              },
                                              icon: const Icon(Icons.refresh,
                                                  color: Colors.green)),
                                            PrintWidget(
                                              tooltip: 'Imprimer le bon de commande',
                                              onPressed: () {
                                            BonCommandePDFA6().generatePdf(
                                                widget
