...
import 'package:wm_com_ivanna/src/pages/restaurant/components/factures/cart/table_creance_rest_cart.dart';
...
class DetailCreanceRestaurant extends StatefulWidget {
  const DetailCreanceRestaurant(
      {super.key, required this.creanceRestaurantModel});
  final CreanceRestaurantModel creanceRestaurantModel;

  @override
  State<DetailCreanceRestaurant> createState() =>
      _DetailCreanceRestaurantState();
}

class _DetailCreanceRestaurantState extends State<DetailCreanceRestaurant> {
  final CreanceRestaurantController controller = Get.find();
