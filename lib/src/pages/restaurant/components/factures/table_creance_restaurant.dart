...
class TableCreanceRestaurant extends StatefulWidget {
  const TableCreanceRestaurant(
      {super.key,
  ...
  final CreanceRestaurantController controller;
  final ProfilController profilController;

  @override
  State<TableCreanceRestaurant> createState() => _TableCreanceRestaurantState();
}

class _TableCreanceRestaurantState extends State<TableCreanceRestaurant> {
    ...
    return Container(
      ...
      child: PlutoGrid(
        ...
        onRowDoubleTap: (PlutoGridOnRowDoubleTapEvent tapEvent) async {
          ...
          Get.toNamed(RestaurantRoutes.creanceRestaurantDetail, arguments: creanceRestaurantModel);
        },
            ...
            children: [
              ...
              IconButton(
                  onPressed: () {
                    ...
                    Navigator.pushNamed(context, RestaurantRoutes.factureRestaurant);
                  },
