...
class TableFactureRestCart extends StatefulWidget {
  const TableFactureRestCart({Key? key, required this.factureList})
      : super(key: key);
  final List<RestaurantModel> factureList;

  @override
  State<TableFactureRestCart> createState() => _TableFactureRestCartState();
}

class _TableFactureRestCartState extends State<TableFactureRestCart> {
