...
class TableFactureRestaurant extends StatefulWidget {
  const TableFactureRestaurant(
      {super.key,
      required this.factureList,
      required this.controller,
      required this.profilController});
  final List<FactureRestaurantModel> factureList;
  final FactureRestaurantController controller;
  final ProfilController profilController;

  @override
  State<TableFactureRestaurant> createState() => _TableFactureRestaurantState();
}

class _TableFactureRestaurantState extends State<TableFactureRestaurant> {
    ...
    return Container(
      ...
      child: PlutoGrid(
        ...
        onRowDoubleTap: (PlutoGridOnRowDoubleTapEvent tapEvent) async {
          ...
          Get.toNamed(RestaurantRoutes.factureRestaurantDetail, arguments: factureRestaurantModel);
        },
