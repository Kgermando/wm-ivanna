...
class AjoutProdModelRest extends StatefulWidget {
  const AjoutProdModelRest({super.key});

  @override
  State<AjoutProdModelRest> createState() => _AjoutProdModelRestState();
}
 
class _AjoutProdModelRestState extends State<AjoutProdModelRest> {
