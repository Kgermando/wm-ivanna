...
class DetailProdModelRest extends StatefulWidget {
  const DetailProdModelRest({super.key, required this.productModel});
  final ProductModel productModel;

  @override
  State<DetailProdModelRest> createState() => _DetailProdModelRestState();
}

class _DetailProdModelRestState extends State<DetailProdModelRest> {
      ...
      onPressed: () => showDialog<String>(
        ...
        builder: (BuildContext context) => AlertDialog(
          ...
          actions: <Widget>[
            ...
            TextButton(
              onPressed: () {
                Get.toNamed(RestaurantRoutes.prodModelRestaurantUpdate,
