...
class TableProduitRestModel extends StatefulWidget {
  const TableProduitRestModel(
  ...
  @override
  State<TableProduitRestModel> createState() => _TableProduitRestModelState();
}

class _TableProduitRestModelState extends State<TableProduitRestModel> {
    ...
    return Obx(() => widget.controller.isLoading
        ...
        : PlutoGrid(
            ...
            onRowDoubleTap: (PlutoGridOnRowDoubleTapEvent tapEvent) async {
              ...
              Get.toNamed(RestaurantRoutes.prodModelRestaurantDetail,
                    ...
                    children: [
                      IconButton(
                          onPressed: () {
                            ...
                            Navigator.pushNamed(
                                context, RestaurantRoutes.prodModelRestaurant);
                          },
