...
class CourbeVenteGainDayRest extends StatefulWidget {
  const CourbeVenteGainDayRest(
  ...
  @override
  State<CourbeVenteGainDayRest> createState() => _CourbeVenteGainDayRestState();
}

class _CourbeVenteGainDayRestState extends State<CourbeVenteGainDayRest> {
