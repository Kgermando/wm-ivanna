...
class ArticlePlusVendusRest extends StatefulWidget {
  const ArticlePlusVendusRest(
  ...
  @override
  State<ArticlePlusVendusRest> createState() => _ArticlePlusVendusRestState();
}

class _ArticlePlusVendusRestState extends State<ArticlePlusVendusRest> {
