...
class CourbeVenteGainYearRest extends StatefulWidget {
  const CourbeVenteGainYearRest(
  ...
  @override
  State<CourbeVenteGainYearRest> createState() => _CourbeVenteGainYearRestState();
}

class _CourbeVenteGainYearRestState extends State<CourbeVenteGainYearRest> {
