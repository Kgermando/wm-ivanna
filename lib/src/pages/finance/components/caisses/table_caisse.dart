...
import 'package:wm_com_ivanna/src/pages/finance/components/caisses/caisse_xlsx.dart';
...
import 'package:wm_com_ivanna/src/widgets/responsive_child3_widget.dart';
        ...
        Expanded(
          child: Obx(() => widget.controller.isLoading
              ...
              : PlutoGrid(
                  ...
                  rows: rows,
                  onRowDoubleTap:
                      (PlutoGridOnRowDoubleTapEvent tapEvent) async {
                  ...
                  createHeader: (PlutoGridStateManager header) {
                    return Row(
                      ...
                      children: [
                        TitleWidget(
                            title: widget.caisseNameModel.nomComplet
                                .toUpperCase()),
                        Row(
                          children: [
                            IconButton(
