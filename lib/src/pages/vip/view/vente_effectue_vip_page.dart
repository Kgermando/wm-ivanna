...
import 'package:wm_com_ivanna/src/pages/vip/components/vente_effectue/vente_effectue_vip_xlsx.dart';
...
class _VenteEffectueVipState extends State<VenteEffectueVip> {
  final VenteEffectueVipController controller = Get.put(VenteEffectueVipController());
                                                ...
                                                .where((element) =>
                                                    ...
                                                    element.created
                                                        ...
                                                        date2!
                                                            .millisecondsSinceEpoch)
                                                .toList();
                                            VenteEffectueVipXlsx().exportToExcel(
                                                title, reppoting);
            ...
            return Card(
              child: ExpansionTile(
                ...
                children: List.generate(ventList.length, (index) {
                  ...
                  return ListTile(
                    onTap: () => Get.toNamed(
                        VipRoutes.ventEffectueVipDetail,
                        arguments: vente),
