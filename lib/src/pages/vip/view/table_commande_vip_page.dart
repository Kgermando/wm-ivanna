...
class TableCommandeVipPage extends StatefulWidget {
  const TableCommandeVipPage({super.key});

  @override
  State<TableCommandeVipPage> createState() => _TableCommandeVipPageState();
}

class _TableCommandeVipPageState extends State<TableCommandeVipPage> {
  final TableVipController controller =
      Get.put(TableVipController());
  final VipController restaurantController =
  ...
  Widget tableWidget(TableRestaurantModel data) {
    return restaurantController.obx(
      ...
      return InkWell(
        onTap: () => Get.toNamed(VipRoutes.tableCommandeVipDetail,
            arguments: data),
        child: ClipRRect(
