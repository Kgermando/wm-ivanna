...
class DetailVenteEffectueVip extends StatefulWidget {
  const DetailVenteEffectueVip({super.key, required this.venteRestaurantModel});
  final VenteRestaurantModel venteRestaurantModel;

  @override
  State<DetailVenteEffectueVip> createState() => _DetailVenteEffectueVipState();
}

class _DetailVenteEffectueVipState extends State<DetailVenteEffectueVip> {
  final VenteEffectueVipController controller = Get.find();
