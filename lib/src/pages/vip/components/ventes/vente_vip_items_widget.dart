...
class VenteVipItemWidget extends StatefulWidget {
  const VenteVipItemWidget(
      {Key? key,
  ...
  final VipController vipController;

  @override
  State<VenteVipItemWidget> createState() => _VenteVipItemWidgetState();
}

class _VenteVipItemWidgetState extends State<VenteVipItemWidget> {
  final ProfilController profilController = Get.find();
  final TableVipController tableVipController =
  ...
  Widget onChanged() {
    return tableVipController.obx((state) {
      var tableList = state!.map((e) => e.table).toList();
      return Obx(() => (widget.vipController.isLoading)
          ? loadingMini()
          : DropdownButtonFormField<String>(
              ...
              onChanged: (value) {
                setState(() {
                  ...
                  if (form.validate()) {
                    widget.vipController.addCommande(
