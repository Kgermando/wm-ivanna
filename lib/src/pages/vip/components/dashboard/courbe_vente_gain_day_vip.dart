...
class CourbeVenteGainDayVip extends StatefulWidget {
  const CourbeVenteGainDayVip(
  ...
  @override
  State<CourbeVenteGainDayVip> createState() => _CourbeVenteGainDayVipState();
}

class _CourbeVenteGainDayVipState extends State<CourbeVenteGainDayVip> {
