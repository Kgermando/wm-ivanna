...
class ArticlePlusVendusVip extends StatefulWidget {
  const ArticlePlusVendusVip(
  ...
  @override
  State<ArticlePlusVendusVip> createState() => _ArticlePlusVendusVipState();
}

class _ArticlePlusVendusVipState extends State<ArticlePlusVendusVip> {
