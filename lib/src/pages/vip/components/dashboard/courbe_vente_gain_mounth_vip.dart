...
class CourbeVenteGainMounthVip extends StatefulWidget {
  const CourbeVenteGainMounthVip(
  ...
  @override
  State<CourbeVenteGainMounthVip> createState() => _CourbeVenteGainMounthVipState();
}

class _CourbeVenteGainMounthVipState extends State<CourbeVenteGainMounthVip> {
