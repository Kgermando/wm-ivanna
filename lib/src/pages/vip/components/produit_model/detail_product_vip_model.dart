...
class DetailProdModelVip extends StatefulWidget {
  const DetailProdModelVip({super.key, required this.productModel});
  final ProductModel productModel;

  @override
  State<DetailProdModelVip> createState() => _DetailProdModelVipState();
}

class _DetailProdModelVipState extends State<DetailProdModelVip> {
      ...
      onPressed: () => showDialog<String>(
        ...
        builder: (BuildContext context) => AlertDialog(
          ...
          actions: <Widget>[
            ...
            TextButton(
              onPressed: () {
                Get.toNamed(VipRoutes.prodModelVipUpdate,
