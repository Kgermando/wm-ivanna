...
class TableProduitVipModel extends StatefulWidget {
  const TableProduitVipModel(
  ...
  @override
  State<TableProduitVipModel> createState() => _TableProduitVipModelState();
}

class _TableProduitVipModelState extends State<TableProduitVipModel> {
    ...
    return Obx(() => widget.controller.isLoading
        ...
        : PlutoGrid(
            ...
            onRowDoubleTap: (PlutoGridOnRowDoubleTapEvent tapEvent) async {
              ...
              Get.toNamed(VipRoutes.prodModelVipDetail,
                    ...
                    children: [
                      IconButton(
                          onPressed: () {
                            ...
                            Navigator.pushNamed(
                                context, VipRoutes.prodModelVip);
                          },
