...
class AjoutProdModelVip extends StatefulWidget {
  const AjoutProdModelVip({super.key});

  @override
  State<AjoutProdModelVip> createState() => _AjoutProdModelVipState();
}
 
class _AjoutProdModelVipState extends State<AjoutProdModelVip> {
