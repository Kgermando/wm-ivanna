...
class UpdateProdModelVip extends StatefulWidget {
  const UpdateProdModelVip({super.key, required this.productModel});
  final ProductModel productModel;

  @override
  State<UpdateProdModelVip> createState() => _UpdateProdModelVipState();
}

class _UpdateProdModelVipState extends State<UpdateProdModelVip> {
