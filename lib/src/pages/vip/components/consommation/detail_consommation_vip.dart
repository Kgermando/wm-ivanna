...
import 'package:wm_com_ivanna/src/pages/vip/components/consommation/pro_format_vip.dart'; 
...
class DetailConsommationVip extends StatefulWidget {
  const DetailConsommationVip({super.key, required this.tableRestaurantModel});
  final TableRestaurantModel tableRestaurantModel;

  @override
  State<DetailConsommationVip> createState() => _DetailConsommationVipState();
}

class _DetailConsommationVipState extends State<DetailConsommationVip> {
    ...
    return SpeedDial(
      ...
      speedDialChildren: <SpeedDialChild>[
        SpeedDialChild(
            ...
            label: 'Facture Pro',
            onPressed: () {
              ProFormatVipPDFA6().generatePdf(widget.tableRestaurantModel.table,
          ...
          return StatefulBuilder(builder: (context, StateSetter setState) {
            return AlertDialog(
              ...
              content: SizedBox(
                  height: 200,
                  width: 200,
                  child: Obx(() => vipController.isFactureLoading
                      ? loading()
                      : Form(
                          key: vipController.factureFormKey,
                          child: Column(
                            children: [
                              nomClientWidget(),
                              telephoneWidget(),
              ...
              actions: <Widget>[
                TextButton(
                  onPressed: () {
                    final form =
                        vipController.factureFormKey.currentState!;
                    if (form.validate()) {
                      vipController.submitFacture(restaurants);
                      form.reset();
                      Navigator.pop(context, 'ok');
                    }
                  },
                ...
                TextButton(
                  onPressed: () {
                    ...
                    if (form.validate()) {
                      vipController.submitFacture(restaurants);
                      vipController.createFacturePDF(restaurants);
                      form.reset();
                      Navigator.pop(context, 'ok');
                    }
                  },
          ...
          return StatefulBuilder(builder: (context, StateSetter setState) {
            return AlertDialog(
              ...
              content: SizedBox(
                  height: 400,
                  width: 300,
                  child: Obx(() => vipController.isCreanceLoading
                      ? loading()
                      : Form(
                          key: vipController.creanceFormKey,
                          child: Column(
                            children: [
              ...
              actions: <Widget>[
                TextButton(
                  onPressed: () {
                    final form =
                        vipController.creanceFormKey.currentState!;
                    if (form.validate()) {
                      vipController.submitFactureCreance(restaurants);
                      form.reset();
                      Navigator.pop(context, 'ok');
                    }
                  },
                ...
                TextButton(
                  onPressed: () {
                    ...
                    if (form.validate()) {
                      vipController.submitFactureCreance(restaurants);
                      vipController.createPDFCreance(restaurants);
                      form.reset();
                      Navigator.pop(context, 'ok');
                    }
                  },
  ...
  Widget nomClientWidget() {
    return Container(
        ...
        child: TextFormField(
          controller: vipController.nomClientController,
  ...
  Widget telephoneWidget() {
    return Container(
        margin: const EdgeInsets.only(bottom: p20),
        child: TextFormField(
          controller: vipController.telephoneController,
          decoration: InputDecoration(
            border:
                OutlineInputBorder(borderRadius: BorderRadius.circular(10.0)),
            labelText: 'Téléphone',
  ...
  Widget nomClientACreditWidget() {
    return Container(
        margin: const EdgeInsets.only(bottom: p20),
        child: TextFormField(
          controller: vipController.nomClientAcreditController,
          decoration: InputDecoration(
            border:
                OutlineInputBorder(borderRadius: BorderRadius.circular(10.0)),
            labelText: 'Nom du client',
  ...
  Widget telephoneACreditWidget() {
    return Container(
        margin: const EdgeInsets.only(bottom: p20),
        child: TextFormField(
          controller: vipController.telephoneAcreditController,
          decoration: InputDecoration(
            border:
                OutlineInputBorder(borderRadius: BorderRadius.circular(10.0)),
            labelText: 'Téléphone',
  ...
  Widget adresseACreditWidget() {
    return Container(
        margin: const EdgeInsets.only(bottom: p20),
        child: TextFormField(
          controller: vipController.addresseAcreditController,
          decoration: InputDecoration(
            border:
                OutlineInputBorder(borderRadius: BorderRadius.circular(10.0)),
            labelText: 'Adresse',
    ...
    return Container(
        ...
        child: TextButton.icon(
            onPressed: () async {
              ...
              vipController.delaiPaiementAcredit = dateTime;
            },
