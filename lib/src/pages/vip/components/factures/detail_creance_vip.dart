...
import 'package:wm_com_ivanna/src/pages/vip/components/factures/cart/table_creance_vip_cart.dart'; 
...
class DetailCreanceVip extends StatefulWidget {
  const DetailCreanceVip(
      {super.key, required this.creanceRestaurantModel});
  final CreanceRestaurantModel creanceRestaurantModel;

  @override
  State<DetailCreanceVip> createState() =>
      _DetailCreanceVipState();
}

class _DetailCreanceVipState extends State<DetailCreanceVip> {
  final CreanceVipController controller = Get.find();
  final MonnaieStorage monnaieStorage = Get.put(MonnaieStorage());
  final CreanceVipPDFA6 creanceRestaurantPDFA6 =
