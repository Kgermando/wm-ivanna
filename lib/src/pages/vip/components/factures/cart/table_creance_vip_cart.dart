...
class TableCreanceVipCart extends StatefulWidget {
  const TableCreanceVipCart({Key? key, required this.factureList})
      : super(key: key);
  final List<RestaurantModel> factureList;

  @override
  State<TableCreanceVipCart> createState() => _TableCreanceVipCartState();
}

class _TableCreanceVipCartState extends State<TableCreanceVipCart> {
