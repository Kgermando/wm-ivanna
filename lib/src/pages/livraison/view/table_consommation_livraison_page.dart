...
class TableConsommationLivraisonPage extends StatefulWidget {
  const TableConsommationLivraisonPage({super.key});

  @override
  State<TableConsommationLivraisonPage> createState() => _TableConsommationLivraisonPageState();
}

class _TableConsommationLivraisonPageState extends State<TableConsommationLivraisonPage> {
  ...
  Widget tableWidget(TableRestaurantModel data) {
    return restaurantController.obx(
      ...
      return InkWell(
        onTap: () => Get.toNamed(
            LivraisonRoutes.tableConsommationLivraisonDetail,
            arguments: data),
        child: ClipRRect(
