...
class ProdModelLivraisonController extends GetxController
  ...
  void getList() async {
    await prodModellivraisonStore.getAllData().then((response) {
  ...
  detailView(int id) async {
    ...
    final data = await prodModellivraisonStore.getOneData(id);
  ...
  void deleteData(int id) async {
    try {
      _isLoading.value = true;
      await prodModellivraisonStore.deleteData(id).then((value) {
        clear();
        produitModelList.clear();
        getList();
        Get.back();
