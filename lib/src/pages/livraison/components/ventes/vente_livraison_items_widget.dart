...
class VenteLivraisonItemWidget extends StatefulWidget {
  const VenteLivraisonItemWidget(
      {Key? key,
      required this.controller,
      required this.productModel,
      required this.profilController,
      required this.livraisonController})
      : super(key: key);
  ...
  @override
  State<VenteLivraisonItemWidget> createState() => _VenteLivraisonItemWidgetState();
}

class _VenteLivraisonItemWidgetState extends State<VenteLivraisonItemWidget> {
  final ProfilController profilController = Get.find();
  final TableLivraisonController tablelivraisonController =
  ...
  Widget onChanged() {
    return tablelivraisonController.obx((state) {
      var tableList = state!.map((e) => e.table).toList();
      return Obx(() => (widget.livraisonController.isLoading)
          ? loadingMini()
          : DropdownButtonFormField<String>(
              ...
              onChanged: (value) {
                setState(() {
                  ...
                  if (form.validate()) {
                    widget.livraisonController.addCommande(
