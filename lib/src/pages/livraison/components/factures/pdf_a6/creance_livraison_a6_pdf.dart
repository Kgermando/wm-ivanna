...
class CreanceLivraisonPDFA6 extends GetxController {
  generatePdf(CreanceRestaurantModel creanceRestaurantModel, String monnaie) async {
  ...
  static Widget buildInvoiceInfo(
      CreanceRestaurantModel creanceRestaurantModel, UserModel user, String monnaie) { 
