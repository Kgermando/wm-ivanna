...
class TableCreanceLivraisonCart extends StatefulWidget {
  const TableCreanceLivraisonCart({Key? key, required this.factureList})
      : super(key: key);
  final List<RestaurantModel> factureList;

  @override
  State<TableCreanceLivraisonCart> createState() => _TableCreanceLivraisonCartState();
}

class _TableCreanceLivraisonCartState extends State<TableCreanceLivraisonCart> {
