...
import 'package:wm_com_ivanna/src/pages/livraison/components/factures/cart/table_creance_livraison_cart.dart'; 
...
class DetailCreanceLivraison extends StatefulWidget {
  const DetailCreanceLivraison(
      {super.key, required this.creanceRestaurantModel});
  final CreanceRestaurantModel creanceRestaurantModel;

  @override
  State<DetailCreanceLivraison> createState() =>
      _DetailCreanceLivraisonState();
}

class _DetailCreanceLivraisonState extends State<DetailCreanceLivraison> {
  final CreanceLivraisonController controller = Get.find();
  final MonnaieStorage monnaieStorage = Get.put(MonnaieStorage());
  final CreanceLivraisonPDFA6 creanceRestaurantPDFA6 =
