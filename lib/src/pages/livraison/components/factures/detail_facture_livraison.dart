...
import 'package:wm_com_ivanna/src/pages/livraison/components/factures/cart/table_facture_livraison_cart.dart'; 
...
class DetailFactureLivraison extends StatefulWidget {
  const DetailFactureLivraison(
      {super.key, required this.factureRestaurantModel});
  final FactureRestaurantModel factureRestaurantModel;

  @override
  State<DetailFactureLivraison> createState() =>
      _DetailFactureLivraisonState();
}

class _DetailFactureLivraisonState extends State<DetailFactureLivraison> {
  final FactureLivraisonController controller = Get.find();
  final MonnaieStorage monnaieStorage = Get.put(MonnaieStorage());
  final FactureLivraisonPDFA6 factureRestaurantPDFA6 =
