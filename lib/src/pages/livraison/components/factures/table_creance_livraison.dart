...
class TableCreanceLivraison extends StatefulWidget {
  const TableCreanceLivraison(
      {super.key,
  ...
  final CreanceLivraisonController controller;
  final ProfilController profilController;

  @override
  State<TableCreanceLivraison> createState() => _TableCreanceLivraisonState();
}

class _TableCreanceLivraisonState extends State<TableCreanceLivraison> {
    ...
    return Container(
      ...
      child: PlutoGrid(
        ...
        onRowDoubleTap: (PlutoGridOnRowDoubleTapEvent tapEvent) async {
          ...
          Get.toNamed(LivraisonRoutes.creanceLivraisonDetail, arguments: creanceRestaurantModel);
        },
