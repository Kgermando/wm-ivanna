...
class BonCommandeLivraisonPDFA6 extends GetxController {
  generatePdf(String table, List<RestaurantModel> restaurants, String monnaie) async {
  ...
  static Widget buildTitle(String table) => Column(
