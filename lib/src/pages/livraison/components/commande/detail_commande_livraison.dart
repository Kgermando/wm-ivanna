...
import 'package:wm_com_ivanna/src/pages/livraison/components/commande/bon_commande_livraison.dart';
...
class DetailCommandeLivraison extends StatefulWidget {
  const DetailCommandeLivraison({super.key, required this.tableRestaurantModel});
  final TableRestaurantModel tableRestaurantModel;

  @override
  State<DetailCommandeLivraison> createState() => _DetailCommandeLivraisonState();
}

class _DetailCommandeLivraisonState extends State<DetailCommandeLivraison> {
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          PrintWidget(
                                              ...
                                              onPressed: () {
                                                BonCommandeLivraisonPDFA6().generatePdf(
