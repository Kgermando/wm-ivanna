...
class CourbeVenteGainYearLivraison extends StatefulWidget {
  const CourbeVenteGainYearLivraison(
  ...
  @override
  State<CourbeVenteGainYearLivraison> createState() => _CourbeVenteGainYearLivraisonState();
}

class _CourbeVenteGainYearLivraisonState extends State<CourbeVenteGainYearLivraison> {
