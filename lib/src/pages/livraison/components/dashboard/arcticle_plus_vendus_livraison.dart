...
class ArticlePlusVendusLivraison extends StatefulWidget {
  const ArticlePlusVendusLivraison(
  ...
  @override
  State<ArticlePlusVendusLivraison> createState() => _ArticlePlusVendusLivraisonState();
}

class _ArticlePlusVendusLivraisonState extends State<ArticlePlusVendusLivraison> {
