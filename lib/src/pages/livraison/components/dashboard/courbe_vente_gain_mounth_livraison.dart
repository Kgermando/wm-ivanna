...
class CourbeVenteGainMounthLivraison extends StatefulWidget {
  const CourbeVenteGainMounthLivraison(
  ...
  @override
  State<CourbeVenteGainMounthLivraison> createState() => _CourbeVenteGainMounthLivraisonState();
}

class _CourbeVenteGainMounthLivraisonState extends State<CourbeVenteGainMounthLivraison> {
