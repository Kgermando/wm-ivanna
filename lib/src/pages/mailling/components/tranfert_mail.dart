...
class TransfertMail extends StatefulWidget {
  const TransfertMail({super.key, required this.mailModel});
...
class _TransfertMailState extends State<TransfertMail> {
  ...
  initState() {
    ...
    controller.messageController =
        TextEditingController(text: widget.mailModel.message);
    controller.pieceJointeController =
        TextEditingController(text: widget.mailModel.pieceJointe);
    super.initState();
  }
                        ...
                        child: Padding(
                          ...
                          child: Form(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                const TitleWidget(title: "Tranferer le mail"),
                                const SizedBox(
                                  height: p20,
                                ),
                                emailWidget(),
