...
class UpdateArchive extends StatefulWidget {
  const UpdateArchive({super.key, required this.archiveModel});
  final ArchiveModel archiveModel;

  @override
  State<UpdateArchive> createState() => _UpdateArchiveState();
}

class _UpdateArchiveState extends State<UpdateArchive> {
  ...
  void initState() {
    controller.nomDocumentController =
        TextEditingController(text: widget.archiveModel.nomDocument);
    controller.descriptionController =
        TextEditingController(text: widget.archiveModel.description);
    controller.level = widget.archiveModel.level;
    super.initState();
  }
                                ...
                                children: [
                                  ...
                                  Obx(() => BtnWidget(
                                      ...
                                      press: () {
                                        ...
                                        if (form.validate()) {
                                          controller
                                              .updateData(widget.archiveModel);
                                          form.reset();
                                        }
                                      }))
                                ],
