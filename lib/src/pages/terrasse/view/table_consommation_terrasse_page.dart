...
class TableConsommationTerrassePage extends StatefulWidget {
  const TableConsommationTerrassePage({super.key});

  @override
  State<TableConsommationTerrassePage> createState() => _TableConsommationTerrassePageState();
}

class _TableConsommationTerrassePageState extends State<TableConsommationTerrassePage> {
  ...
  Widget tableWidget(TableRestaurantModel data) {
    return restaurantController.obx(
      ...
      return InkWell(
        onTap: () => Get.toNamed(
            TerrasseRoutes.tableConsommationTerrasseDetail,
            arguments: data),
        child: ClipRRect(
