...
class TableCommandeTerrassePage extends StatefulWidget {
  const TableCommandeTerrassePage({super.key});

  @override
  State<TableCommandeTerrassePage> createState() => _TableCommandeTerrassePageState();
}

class _TableCommandeTerrassePageState extends State<TableCommandeTerrassePage> {
  final TableTerrasseController controller =
      Get.put(TableTerrasseController());
  final TerrasseController restaurantController =
      Get.put(TerrasseController());
  ...
  Widget tableWidget(TableRestaurantModel data) {
    return restaurantController.obx(
      ...
      return InkWell(
        onTap: () => Get.toNamed(
            TerrasseRoutes.tableCommandeTerrasseDetail,
            arguments: data),
        child: ClipRRect(
