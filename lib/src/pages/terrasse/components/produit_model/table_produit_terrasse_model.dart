...
class TableProduitTerrasseModel extends StatefulWidget {
  const TableProduitTerrasseModel(
  ...
  @override
  State<TableProduitTerrasseModel> createState() => _TableProduitTerrasseModelState();
}

class _TableProduitTerrasseModelState extends State<TableProduitTerrasseModel> {
    ...
    return Obx(() => widget.controller.isLoading
        ...
        : PlutoGrid(
            ...
            onRowDoubleTap: (PlutoGridOnRowDoubleTapEvent tapEvent) async {
              ...
              Get.toNamed(TerrasseRoutes.prodModelTerrasseDetail,
                    ...
                    children: [
                      IconButton(
                          onPressed: () {
                            ...
                            Navigator.pushNamed(
                                context, TerrasseRoutes.prodModelTerrasse);
                          },
