...
class DetailVenteEffectueTerrasse extends StatefulWidget {
  const DetailVenteEffectueTerrasse({super.key, required this.venteRestaurantModel});
  final VenteRestaurantModel venteRestaurantModel;

  @override
  State<DetailVenteEffectueTerrasse> createState() => _DetailVenteEffectueTerrasseState();
}

class _DetailVenteEffectueTerrasseState extends State<DetailVenteEffectueTerrasse> {
  final VenteEffectueTerrasseController controller = Get.find();
                ...
                children: [
                  Visibility(
                      ...
                      child: const Expanded(
                          flex: 1, child: DrawerMenuTerrasse())),
                  Expanded(
                      flex: 5,
