...
class CourbeVenteGainDayTerrasse extends StatefulWidget {
  ...
  @override
  State<CourbeVenteGainDayTerrasse> createState() => _CourbeVenteGainDayTerrasseState();
}

class _CourbeVenteGainDayTerrasseState extends State<CourbeVenteGainDayTerrasse> {
