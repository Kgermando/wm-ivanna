...
class CourbeVenteGainMounthTerrasse extends StatefulWidget {
  const CourbeVenteGainMounthTerrasse(
  ...
  @override
  State<CourbeVenteGainMounthTerrasse> createState() => _CourbeVenteGainMounthTerrasseState();
}

class _CourbeVenteGainMounthTerrasseState extends State<CourbeVenteGainMounthTerrasse> {
