...
class CourbeVenteGainYearTerrasse extends StatefulWidget {
  const CourbeVenteGainYearTerrasse(
  ...
  @override
  State<CourbeVenteGainYearTerrasse> createState() => _CourbeVenteGainYearTerrasseState();
}

class _CourbeVenteGainYearTerrasseState extends State<CourbeVenteGainYearTerrasse> {
