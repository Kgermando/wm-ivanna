...
class TableCreanceTerrasse extends StatefulWidget {
  const TableCreanceTerrasse(
      {super.key,
  ...
  final CreanceTerrasseController controller;
  final ProfilController profilController;

  @override
  State<TableCreanceTerrasse> createState() => _TableCreanceTerrasseState();
}

class _TableCreanceTerrasseState extends State<TableCreanceTerrasse> {
    ...
    return Container(
      ...
      child: PlutoGrid(
        ...
        onRowDoubleTap: (PlutoGridOnRowDoubleTapEvent tapEvent) async {
          ...
          Get.toNamed(TerrasseRoutes.creanceTerrasseDetail, arguments: creanceRestaurantModel);
        },
            ...
            children: [
              ...
              IconButton(
                onPressed: () {
                  ...
                  Navigator.pushNamed(context, TerrasseRoutes.factureTerrasse);
                },
