...
class TableFactureTerrasseCart extends StatefulWidget {
  const TableFactureTerrasseCart({Key? key, required this.factureList})
      : super(key: key);
  final List<RestaurantModel> factureList;

  @override
  State<TableFactureTerrasseCart> createState() => _TableFactureTerrasseCartState();
}

class _TableFactureTerrasseCartState extends State<TableFactureTerrasseCart> {
