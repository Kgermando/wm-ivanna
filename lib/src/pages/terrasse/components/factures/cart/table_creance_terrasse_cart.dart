...
class TableCreanceTerrasseCart extends StatefulWidget {
  const TableCreanceTerrasseCart({Key? key, required this.factureList})
      : super(key: key);
  final List<RestaurantModel> factureList;

  @override
  State<TableCreanceTerrasseCart> createState() => _TableCreanceTerrasseCartState();
}

class _TableCreanceTerrasseCartState extends State<TableCreanceTerrasseCart> {
