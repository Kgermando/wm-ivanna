...
import 'package:wm_com_ivanna/src/pages/terrasse/components/factures/cart/table_facture_terrasse_cart.dart'; 
...
class DetailFactureTerrasse extends StatefulWidget {
  const DetailFactureTerrasse(
      {super.key, required this.factureRestaurantModel});
  final FactureRestaurantModel factureRestaurantModel;

  @override
  State<DetailFactureTerrasse> createState() =>
      _DetailFactureTerrasseState();
}

class _DetailFactureTerrasseState extends State<DetailFactureTerrasse> {
  final FactureTerrasseController controller = Get.find();
  final MonnaieStorage monnaieStorage = Get.put(MonnaieStorage());
  final FactureTerrassePDFA6 factureRestaurantPDFA6 =
