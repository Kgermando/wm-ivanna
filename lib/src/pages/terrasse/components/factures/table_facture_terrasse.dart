...
class TableFactureTerrasse extends StatefulWidget {
  const TableFactureTerrasse(
      {super.key,
      required this.factureList,
      required this.controller,
      required this.profilController});
  final List<FactureRestaurantModel> factureList;
  final FactureTerrasseController controller;
  final ProfilController profilController;

  @override
  State<TableFactureTerrasse> createState() => _TableFactureTerrasseState();
}

class _TableFactureTerrasseState extends State<TableFactureTerrasse> {
    ...
    return Container(
      ...
      child: PlutoGrid(
        ...
        onRowDoubleTap: (PlutoGridOnRowDoubleTapEvent tapEvent) async {
          ...
          Get.toNamed(TerrasseRoutes.factureTerrasseDetail, arguments: factureRestaurantModel);
        },
