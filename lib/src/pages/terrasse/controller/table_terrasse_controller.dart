...
class TableTerrasseController extends GetxController
    with StateMixin<List<TableRestaurantModel>> {
  TableTerrasseStore tableterrasseStore = TableTerrasseStore();
  ...
  void getList() async {
    tableterrasseStore.getAllData().then((response) {
  ...
  detailView(int id) => tableterrasseStore.getOneData(id);

  void deleteData(int id) async {
    try {
      _isLoading.value = true;
      await tableterrasseStore.deleteData(id).then((value) {
        tableRestaurantList.clear();
        getList();
