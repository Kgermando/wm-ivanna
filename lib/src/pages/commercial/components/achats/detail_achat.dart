...
import 'package:wm_com_ivanna/src/pages/commercial/components/achats/achat_pdf.dart';
import 'package:wm_com_ivanna/src/pages/commercial/components/achats/table_history_ravitaillement_produit.dart';
      ...
      onPressed: () => showDialog<String>(
        ...
        builder: (BuildContext context) => AlertDialog(
          ...
          actions: <Widget>[
            ...
            TextButton(
              onPressed: () {
                controller.deleteData(widget.achatModel.id!);
      ...
      onPressed: () => showDialog<String>(
        ...
        builder: (BuildContext context) => AlertDialog(
          ...
          actions: <Widget>[
            ...
            TextButton(
              onPressed: () {
                Get.toNamed(ComRoutes.comAchatUpdate,
                    arguments: widget.achatModel);
