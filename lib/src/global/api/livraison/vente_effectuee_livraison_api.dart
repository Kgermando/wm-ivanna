...
class VenteEffectueLivraisonApi extends GetConnect {
  var client = http.Client();

  Future<List<VenteRestaurantModel>> getAllData() async {
    Map<String, String> header = headers;

    var resp = await client.get(venteEffectueeLivraisonUrl, headers: header);
  ...
  Future<VenteRestaurantModel> getOneData(int id) async {
    ...
    var getUrl = Uri.parse("$mainUrl/vente-effectuee-livraisons/$id");
  ...
  Future<VenteRestaurantModel> insertData(
    ...
    var resp =
        await client.post(addVenteEffectueeLivraisonUrl, headers: header, body: body);
    if (resp.statusCode == 200) {
      return VenteRestaurantModel.fromJson(json.decode(resp.body));
  ...
  Future<VenteRestaurantModel> updateData(
    ...
    var data = dataItem.toJson(id: dataItem.id!);
    var body = jsonEncode(data);
    var updateUrl = Uri.parse("$mainUrl/vente-effectuee-livraisons/update-vente/");
  ...
  Future<void> deleteData(int id) async {
    ...
    var deleteUrl = Uri.parse("$mainUrl/vente-effectuee-livraisons/delete-vente/$id");
