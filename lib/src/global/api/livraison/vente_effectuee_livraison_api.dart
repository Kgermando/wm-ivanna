...
class VenteEffectueLivraisonApi extends GetConnect {
  ...
  Future<VenteRestaurantModel> insertData(VenteRestaurantModel dataItem) async {
    ...
    var resp = await client.post(addVenteEffectueeLivraisonUrl,
  ...
  Future<VenteRestaurantModel> updateData(VenteRestaurantModel dataItem) async {
    ...
    var body = jsonEncode(data);
    var updateUrl =
        Uri.parse("$mainUrl/vente-effectuee-livraisons/update-vente/");
  ...
  Future<void> deleteData(int id) async {
    ...
    var deleteUrl =
        Uri.parse("$mainUrl/vente-effectuee-livraisons/delete-vente/$id");
