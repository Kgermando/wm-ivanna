...
class ProduitModelLivraisonApi extends GetConnect {
  var client = http.Client();

  Future<List<ProductModel>> getAllData() async {
    Map<String, String> header = headers;

    var resp = await client.get(prodModelLivraisonUrl, headers: header);
  ...
  Future<ProductModel> getOneData(int id) async {
    ...
    var getUrl = Uri.parse("$mainUrl/prod-mode-livraisons/$id");
  ...
  Future<ProductModel> insertData(ProductModel productModel) async {
    ...
    var resp = await client.post(addProdModelLivraisonUrl,
  ...
  Future<ProductModel> updateData(ProductModel productModel) async {
    ...
    var body = jsonEncode(data);
    var updateUrl =
        Uri.parse("$mainUrl/prod-mode-livraisons/update-produit-model/");
  ...
  Future<void> deleteData(int id) async {
    ...
    var deleteUrl =
        Uri.parse("$mainUrl/prod-mode-livraisons/delete-produit-model/$id");
