...
class VenteVipApi extends GetConnect {
  var client = http.Client();

  Future<List<VenteChartRestaurantModel>> getVenteChart() async {
    Map<String, String> header = headers;

    var resp = await client.get(venteChartVipUrl, headers: header);
  ...
  Future<List<CourbeVenteRestaurantModel>> getAllDataVenteDay() async {
    ...
    var resp = await client.get(venteChartDayVipUrl, headers: header);
  ...
  Future<List<CourbeVenteRestaurantModel>> getAllDataVenteMouth() async {
    ...
    var resp = await client.get(venteChartMonthsVipUrl, headers: header);
  ...
  Future<List<CourbeVenteRestaurantModel>> getAllDataVenteYear() async {
    ...
    var resp = await client.get(venteChartYearsVipUrl, headers: header);
