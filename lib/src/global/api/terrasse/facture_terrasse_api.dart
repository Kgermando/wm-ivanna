...
class FactureTerrasseApi extends GetConnect {
  ...
  Future<List<FactureRestaurantModel>> getAllData() async {
    ...
    var resp = await client.get(factureTerrasseUrl, headers: header);
  ...
  Future<FactureRestaurantModel> getOneData(int id) async {
    ...
    var getUrl = Uri.parse("$mainUrl/facture-terrasses/$id");
  ...
  Future<FactureRestaurantModel> insertData(
    ...
    var resp =
        await client.post(addFactureTerrasseUrl, headers: header, body: body);
    if (resp.statusCode == 200) {
      return FactureRestaurantModel.fromJson(json.decode(resp.body));
  ...
  Future<void> deleteData(int id) async {
    ...
    var deleteUrl = Uri.parse("$mainUrl/facture-terrasses/delete-facture/$id");
