...
class VenteEffectueTerrasseStore {
  static final VenteEffectueTerrasseStore _singleton =
      VenteEffectueTerrasseStore._internal();
  factory VenteEffectueTerrasseStore() {
    return _singleton;
  }
  VenteEffectueTerrasseStore._internal();

  static const String tableName = 'vente-effectue-terrasses';
