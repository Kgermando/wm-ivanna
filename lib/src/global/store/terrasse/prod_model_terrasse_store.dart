...
class ProdModelTerrasseStore {
  static final ProdModelTerrasseStore _singleton = ProdModelTerrasseStore._internal();
  factory ProdModelTerrasseStore() {
    return _singleton;
  }
  ProdModelTerrasseStore._internal();

  static const String tableName = 'produit-models-terrasses';
