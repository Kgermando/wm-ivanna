...
class TableTerrasseStore {
  static final TableTerrasseStore _singleton =
      TableTerrasseStore._internal();
  factory TableTerrasseStore() {
    return _singleton;
  }
  TableTerrasseStore._internal();

  static const String tableName = 'table-terrasses';
