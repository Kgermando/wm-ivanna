...
class VenteEffectueRestStore {
  static final VenteEffectueRestStore _singleton =
      VenteEffectueRestStore._internal();
  factory VenteEffectueRestStore() {
    return _singleton;
  }
  VenteEffectueRestStore._internal();

  static const String tableName = 'vente-effectue-restaurants';
