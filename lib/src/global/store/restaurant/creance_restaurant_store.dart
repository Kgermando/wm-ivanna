...
class CreanceRestaurantStore {
  static final CreanceRestaurantStore _singleton =
      CreanceRestaurantStore._internal();
  factory CreanceRestaurantStore() {
    return _singleton;
  }
  CreanceRestaurantStore._internal();

  static const String tableName = 'creance-restaurants';
