...
class FactureRestaurantStore {
  static final FactureRestaurantStore _singleton =
      FactureRestaurantStore._internal();
  factory FactureRestaurantStore() {
    return _singleton;
  }
  FactureRestaurantStore._internal();

  static const String tableName = 'facture-restaurants';
