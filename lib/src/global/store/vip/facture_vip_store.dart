...
class FactureVipStore {
  static final FactureVipStore _singleton =
      FactureVipStore._internal();
  factory FactureVipStore() {
    return _singleton;
  }
  FactureVipStore._internal();

  static const String tableName = 'facture-vips';
