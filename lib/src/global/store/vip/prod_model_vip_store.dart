...
class ProdModelVipStore {
  static final ProdModelVipStore _singleton = ProdModelVipStore._internal();
  factory ProdModelVipStore() {
    return _singleton;
  }
  ProdModelVipStore._internal();

  static const String tableName = 'produit-models-vip';
