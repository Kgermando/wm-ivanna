...
class CreanceVipStore {
  static final CreanceVipStore _singleton =
      CreanceVipStore._internal();
  factory CreanceVipStore() {
    return _singleton;
  }
  CreanceVipStore._internal();

  static const String tableName = 'creance-vips';
