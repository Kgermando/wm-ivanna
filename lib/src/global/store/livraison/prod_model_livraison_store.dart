...
class ProdModelLivraisonStore {
  static final ProdModelLivraisonStore _singleton = ProdModelLivraisonStore._internal();
  factory ProdModelLivraisonStore() {
    return _singleton;
  }
  ProdModelLivraisonStore._internal();

  static const String tableName = 'produit-models-livraisons';
