...
class VenteEffectueLivraisonStore {
  static final VenteEffectueLivraisonStore _singleton =
      VenteEffectueLivraisonStore._internal();
  factory VenteEffectueLivraisonStore() {
    return _singleton;
  }
  VenteEffectueLivraisonStore._internal();

  static const String tableName = 'vente-effectue-livraisons';
