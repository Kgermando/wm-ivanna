...
class TableLivraisonStore {
  static final TableLivraisonStore _singleton =
      TableLivraisonStore._internal();
  factory TableLivraisonStore() {
    return _singleton;
  }
  TableLivraisonStore._internal();

  static const String tableName = 'table-livraisons';
